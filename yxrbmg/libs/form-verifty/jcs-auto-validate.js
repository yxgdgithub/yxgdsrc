...
angular.autoValidate.errorMessages['default'] = {
  defaultMsg: '请为{0}添加错误信息',//Please add error message for {0}
  email: '请输入一个有效的邮箱地址',//Please enter a valid email address
  minlength: '请输入最少{0}个字符',//Please enter at least {0} characters
  maxlength: '您已经输入了超多{0}个字符',//You have entered more than the maximum {0} characters
  min: '请输入大于{0}的数值',//Please enter the minimum number of {0}
  max: '请输入小于{0}的数字',//Please enter the maximum number of {0}
  required: '此输入项不能为空',//This field is required
  date: '请输入一个有效的日期',//Please enter a valid date
  pattern: 'Please ensure the entered information adheres to this pattern {0}',
  number: '请输入一个有效数字',//Please enter a valid number
  url: '请输入一个有效的URL地址，例如www.baidu.com'//Please enter a valid URL in the format of http(s)://www.google.com
};
