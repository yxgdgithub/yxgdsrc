...
! function() {
	...
	function h(e) {
		B = null;
		var t = !1;
		"SELECT" == e.tagName ? (n("mousedown", e, 0, 0), e.focus && e.focus(), t = !0) : g() === e ? t = !0 : /^(input|textarea)$/i.test(e.tagName) || e.isContentEditable ? (t = !0, e.focus && e.focus(), e.value = e.value, W && (B = e)) : f(), t && (g(e), ionic.trigger("ionic.focusin", {
			target: e
		}, !0))
	}
	...
	function v(e) {
		...
		var t = ionic.tap.pointerCoord(e),
			...
			i = n && e.target.classList.contains("button") ? J : j;
	...
	function N() {
		clearTimeout(ie), ionic.keyboard.isOpen = !1, ionic.keyboard.isClosing = !1, ee && ionic.trigger("resetScrollView", {
			target: ee
	...
	function A() {
		ae = !1, oe = k(), ionic.keyboard.isLandscape && !se ? se = oe : ionic.keyboard.isLandscape || re || (re = oe), ee && ionic.trigger("resetScrollView", {
			target: ee
	...
	window.ionic = window.ionic || {}, window.ionic.views = {}, window.ionic.version = "1.0.0",
		function(e) {
	...
	ionic.tap = {
			register: function(t) {
				return Y = t, e("click", !0, !0), e("mouseup"), e("mousedown"), window.navigator.pointerEnabled ? (e("pointerdown"), e("pointerup"), e("pointcancel"), Z = "pointermove") : window.navigator.msPointerEnabled ? (e("MSPointerDown"), e("MSPointerUp"), e("MSPointerCancel"), Z = "MSPointerMove") : (e("touchstart"), e("touchend"), e("touchcancel")), e("focusin"), e("focusout"),
					function() {
...
! function() {
	...
	function t(e, t, n) {
		...
		return function(o) {
			...
			this.refreshLayout = function() {
				...
				if ($.style[ionic.CSS.TRANSFORM] = H.replace(z, -l).replace(M, 0), q -= l, I.__clientHeight && I.__clientWidth || (I.__clientWidth = I.__container.clientWidth, I.__clientHeight = I.__container.clientHeight), (ee.onRefreshLayout || angular.noop)(), ee.refreshDirection(), Q(), !ie)
		...
		return L.prototype.initialize = function(e) {
			...
			register: function(e, t) {
				var i, a, s, u = g(),
					...
					O = d.historyId,
					q = n.url();
				if (b !== u && (b = u, _++), k) z = k.viewId, M = k.action, H = k.direction, k = null;
				else if (L && L.stateId === u) z = L.viewId, O = L.historyId, M = B, L.historyId === $.historyId ? H = x : $ && (H = V, i = f(L.historyId), i && i.parentHistoryId === $.historyId ? H = E : (i = f($.historyId), i && i.parentHistoryId === d.parentHistoryId && (H = P)));
				else if (N && N.stateId === u) z = N.viewId, O = N.historyId, M = I, N.historyId === $.historyId ? H = A : $ && (H = V, $.historyId === d.parentHistoryId ? H = E : (i = f($.historyId), i && i.parentHistoryId === d.parentHistoryId && (H = P))), i = p(e), N.historyId && i.scope && (i.scope.$historyId = N.historyId, O = N.historyId);
				else if ($ && $.historyId !== O && d.cursor > -1 && d.stack.length > 0 && d.cursor < d.stack.length && d.stack[d.cursor].stateId === u) {
				...
				if (v(z), R.backView && O == R.backView.historyId && u == R.backView.stateId && q == R.backView.url)
	...
	c.constant("$ionicLoadingConfig", {
	...
	}).factory("$ionicLoading", ["$ionicLoadingConfig", "$ionicBody", "$ionicTemplateLoader", "$ionicBackdrop", "$timeout", "$q", "$log", "$compile", "$ionicPlatform", "$rootScope", "IONIC_BACK_PRIORITY", function(e, t, n, i, o, r, a, c, l, u, d) {
		function f() {
		...
		function o(e, n) {
			...
			d.left < r ? d.left = r : d.left + c + r > l && (d.left = l - c - r), a.top + a.height + s > u && a.top - s > 0 ? (d.top = a.top - s, n.addClass("popover-bottom")) : (d.top = a.top + a.height, n.removeClass("popover-bottom")), f.css({
			...
			function c(n) {
				...
				return r.then(function(i) {
					...
					return n.controller && (r = t(n.controller, s(n.locals, {
						$scope: a
					})), c.children().data("$ngControllerController", r)), n.appendTo && h(n.appendTo).append(c), e(c)(a), {
						element: c,
						scope: a
					}
				})
					...
					create: function(t, l, h, T, E, R) {
						var L, N, z, M = ++A,
							H = {
								...
								render: function(e, n) {
									if (z) ionic.Utils.reconnectScope(L.scope());
									else {
										p(L, x);
								...
								transition: function(a, c, u) {
									...
									var U = o.transitions.views[O.transition] || o.transitions.views.none,
										W = U(L, N, O.direction, O.shouldAnimate && u && R);
			...
			c.controller("$ionicSpinner", ["$element", "$attrs", function(n, i) {
				...
				this.init = function() {
					...
					return t("svg", {
						viewBox: "0 0 64 64",
						g: [v[o]]
					}, c, o), n.html(c.innerHTML), this.start(), o
				}, this.start = function() {
					g[o] && g[o](n[0])()
				}
			}])
	...
	c.directive("ionReorderButton", ["$parse", function(e) {
		...
		return {
			...
			compile: function(n, i) {
				...
				if (!d && h && "none" !== h && (r.innerHTML = '<i class="icon ' + h + '"></i> ' + r.innerHTML, r.className += " button-clear"), !s) {
					...
					p.className = "back-text", !l && e.backButton.text() && (p.innerHTML += '<span class="default-title">' + "返回" + "</span>"), !u && e.backButton.previousTitleText() && (p.innerHTML += '<span class="previous-title"></span>'), r.appendChild(p)
				}
		...
		return {
			...
			compile: function(e) {
				...
				return o.append(e.contents()), e.append(o), {
					pre: i
				}
			}
		}
